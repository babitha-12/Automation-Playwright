...
//here playwright itself handles eveyrthing like browser intiialisation , launching page etc.. realtime we use this method for test case
//.only used to run only that test case
//will handle multiple pages handle 
